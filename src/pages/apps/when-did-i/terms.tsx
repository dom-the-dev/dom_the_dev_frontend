...
const Terms = () => {
  return (
    <PageLayout pageTitle={'When Did I - Nutzungsbedingungen'}>
      ...
      <Splitline />
      <h3>7. Richtlinien für nutzergenerierte Inhalte</h3>
      <p>
      ...
      <h4>7.1 Respektierung der Rechte anderer</h4>
      <p>
      ...
      <h4>7.3 Moderation und Konsequenzen</h4>
      <p>
