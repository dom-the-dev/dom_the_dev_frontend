  ...
  return (
    <PageLayout pageTitle={'Aloha'}>
      <p className={styles.intro}>
        ...
        crafting sleek and powerful web solutions that dazzle and deliver. Since 2022, I've been
        blazing my own trail as a freelancer, bringing innovation and excellence to every project I
        touch. And since 2023, I've proudly joined the ranks of{' '}
