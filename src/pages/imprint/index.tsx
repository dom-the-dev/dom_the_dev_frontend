  ...
  return (
    <PageLayout pageTitle={'Imprint'}>
      ...
      <p>
        ...
        von entsprechenden Rechtsverletzungen werden wir diese Inhalte umgehend entfernen. Haftung
        für Links Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir
      ...
      <p>
        Beim Besuch dieser Internet-Seiten werden personenbezogene Daten erfasst, wenn Sie diese
        Angaben freiwillig, etwa im Rahmen der Kontaktanfrage per E-Mail, machen und dienen zur
        Beantwortung Ihrer Kontaktanfrage. Eine Weitergabe an Dritte findet nicht statt.
      </p>
    </PageLayout>
  );
};
